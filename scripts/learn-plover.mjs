...
export const LearnPlover = {};


LearnPlover["One Syllable Words"] = [
...
LearnPlover["Inversion"] = [
    "edit", "elves", "twelve", "credit", "portal",
];

LearnPlover["The Fifth Vowel Key"] = [
    "still", "rig", "hit", "sip",
    "sir", "skirt",
    "crypt", "syrup",
...
LearnPlover["Vowel Disambiguator Chords"] = [
...
LearnPlover["The Remaining Missing Letters"] = [
...
LearnPlover["Review Through Missing Letters"] = [
...
LearnPlover["Review Through Digraphs"] = [
...
LearnPlover["Common Compound Clusters"] = [
...
LearnPlover["Review Through Common Compound Clusters"] = [
...
LearnPlover["Common Briefs 1-20"] = [
    "the", "of", "to", "in", "a",
    "is", "that", "with", "be", "by",
    "he", "I", "this", "are", "which",
...
LearnPlover["Common Briefs 21-40"] = [
...
LearnPlover["Common Briefs 41-60"] = [
...
LearnPlover["Common Briefs 61-80"] = [
...
LearnPlover["Common Briefs 81-100"] = [
